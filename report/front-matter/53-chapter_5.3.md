...
En esta entrevista, nos volvemos a comunicar con Jorge Orellana, quien aceptó colaborar para esta entrevista de validación con fines de recolectar información valiosa para la evolución del desarrollo del proyecto Aquanetix. Durante esta, Jorge analizó el panel de control desde una perspectiva operativa y técnica, validando su estructura general. Resaltó que al iniciar la jornada de trabajo, los parámetros del sistema son los elementos que tienen mayor relevancia para la gestión de la planta. Asimismo, confirmó que el uso de un código de colores tipo semáforo es una decisión totalmente acertada y muy intuitiva, ya que permite a los operadores identificar visualmente y a gran velocidad qué elementos requieren atención prioritaria sin la necesidad de revisar manualmente todos los datos adicionales de la pantalla.

En cuanto a la alineación del sistema con los flujos de trabajo de la industria, se determinó que ante un valor anómalo en la tabla de monitoreo en tiempo real, el paso lógico esperado por un operador es poder acceder directamente al detalle de la incidencia. Esto facilitaría la revisión de datos históricos, la geolocalización del problema y la evaluación de su impacto para tomar acciones correctivas inmediatas. Por otro lado, el ingeniero destacó como un factor decisivo de confianza que el software integre explícitamente el contexto de las Entidades Prestadoras de Servicios de Saneamiento (EPS) y el cumplimiento de la Ley General del Ambiente en el Perú, lo cual demuestra que la herramienta está diseñada con base en las necesidades regulatorio-ambientales reales del sector local.

Finalmente, se identificaron importantes oportunidades de mejora para incrementar la eficiencia operativa de la plataforma. Para optimizar la respuesta ante emergencias, se recomendó incorporar un mapa dinámico en el panel de alertas que permita ubicar geográficamente los incidentes, así como enriquecer el texto de las descripciones para que no solo informen que se superó un umbral, sino que incluyan el impacto esperado y recomendaciones técnicas de solución. Adicionalmente, de cara a la gestión administrativa en la sección de suscripción, se sugirió que el sistema cuente con funciones automatizadas y predictivas que alerten al usuario cuando la instalación de nuevos sensores esté por superar la capacidad contratada del plan, recomendando directamente el tipo de actualización necesario.
